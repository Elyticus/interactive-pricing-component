const domReferences = {
  ...
  inputCheckbox: document.getElementById("toggle-btn"),
  rangeSpan: document.getElementById("page-views-count"),
  priceSpan: document.getElementById("price"),
  buttonTrial: document.getElementById("btn"),
};
...
function setPrice(rangeValue, priceValue) {
  ...
  domReferences.priceSpan.innerHTML = priceValue.toLocaleString("en", {
    style: "currency",
    currency: "USD",
  });
}
